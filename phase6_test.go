...
func TestPhase6_AllTools(t *testing.T) {
	...
	t.Run("Browser_Open", func(t *testing.T) {
		...
		result, _ := executeBrowser(args, chatID)
	...
	t.Run("Script_Run", func(t *testing.T) {
		...
		result, _ := executeScript(args, chatID)
	...
	t.Run("Script_List", func(t *testing.T) {
		args := jsonToMap(`{}`)
		result, _ := executeScriptList(args)
	...
	t.Run("Monitor_Add", func(t *testing.T) {
		...
		result, _ := executeMonitor(args, chatID)
...
func TestPhase6_ScriptResult(t *testing.T) {
	...
	result, hasScreenshot := executeScript(args, int64(888888))
	_ = hasScreenshot
	fmt.Printf("  Result: %s\n", truncate(result, 200))
	...
	// Cleanup
	closeBrowserSession(int64(888888))
}
