...
func getOrCreateBrowserSession(chatID int64) *BrowserSession {
	...
	userDataDir := browserSessionPath(fmt.Sprintf("chat_%d", chatID))
...
func browserSessionNavigate(url string, chatID int64) (string, bool) {
	...
	return truncOutput(fmt.Sprintf("🌐 Navigated to: %s\nTitle: %s\n\n%s", url, title, bodyText), maxToolOutput), true
}
...
func browserSessionScreenshot(url string, chatID int64) (string, bool) {
	...
	// Save screenshot
	ssDir := os.Getenv("HOME") + "/.scorp-agent/screenshots"
...
func browserSessionEvaluate(code, url string, chatID int64) (string, bool) {
	...
	return truncOutput(fmt.Sprintf("JS result: %v", result), maxToolOutput), true
}
...
func browserSessionExtract(selector, url string, chatID int64) (string, bool) {
	...
	return truncOutput(text, maxToolOutput), true
}
...
func browserSnapshot(chatID int64) (string, bool) {
	...
	return truncOutput(fmt.Sprintf("📸 <b>Snapshot</b>\nURL: %s\nTitle: %s\n\n%s", url, title, elements), maxToolOutput), true
}
...
func browserConsole(chatID int64) (string, bool) {
	...
	return truncOutput("🖥 <b>Console Output</b>\n\n"+result, maxToolOutput), true
}
