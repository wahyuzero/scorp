...
func init() {
	...
	registerTool(ToolDef{
		...
		Native:      true,
		Execute: func(args map[string]interface{}, chatID int64) (string, bool) {
			return executeDelegateBatch(args)
		},
		Arguments: map[string]ArgDef{
	...
	registerTool(ToolDef{
		Name:        "mcp_manage",
		Description: "Manage MCP servers: list configured servers, add new server (auto-reloads), remove server, or hot-reload all servers without restarting. For Python MCP servers needing user packages, add env: {\"PYTHONPATH\": \"/home/ubuntu/.local/lib/python3.12/site-packages\"}",
		Category:    "system",
		Native:      true,
		Execute: func(args map[string]interface{}, chatID int64) (string, bool) {
			return executeMCPManage(args)
		},
		Arguments: map[string]ArgDef{
	...
	registerTool(ToolDef{
		Name:        "skill_manage",
		Description: "Manage agent skills: list, view, create, update, delete. Skills are stored as JSON files in ~/.scorp-agent/skills/. Built-in skills cannot be deleted.",
		Category:    "system",
		Native:      true,
		Execute: func(args map[string]interface{}, chatID int64) (string, bool) {
			return executeSkillManage(args)
		},
		Arguments: map[string]ArgDef{
	...
	registerTool(ToolDef{
		...
		Native:      true,
		Execute: func(args map[string]interface{}, chatID int64) (string, bool) {
			return executeSessionSearch(args)
		},
		Arguments: map[string]ArgDef{
	...
	registerTool(ToolDef{
		...
		Native:      true,
		Execute: func(args map[string]interface{}, chatID int64) (string, bool) {
			return executeToolSearch(args, chatID)
		},
		Arguments: map[string]ArgDef{
	...
	registerTool(ToolDef{
		...
		Native:      true,
		Execute: func(args map[string]interface{}, chatID int64) (string, bool) {
			return executeToolCall(args, chatID)
		},
		Arguments: map[string]ArgDef{
	...
	registerTool(ToolDef{
		...
		Native:      true,
		Execute: func(args map[string]interface{}, chatID int64) (string, bool) {
			return executeToolList(args, chatID)
		},
		Arguments: map[string]ArgDef{
