...
## Corpus Check
- 274 files · ~193,869 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2150 nodes · 5654 edges · 108 communities (91 shown, 9 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 912 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0f1e235a`
...
### Community 3 - "acp.go"
Cohesion: 0.09
Nodes (29): checkACPAvailable(), launchACP(), listAvailableACP(), ACPError, ACPInitializeParams, ACPMessageNewParams, ACPMessagePart, ACPResponse (+21 more)
...
Cohesion: 0.12
Nodes (31): NewSandbox(), runIn(), sanitizeModuleName(), tail(), Generate(), Repair(), stripCodeFences(), detectRuntime() (+23 more)

### Community 11 - "HandleTelegramAction"
Cohesion: 0.05
Nodes (80): RequestStop(), FormatCompactStats(), CompactStats, HomeDir(), ProjectDir(), PythonSitePackages(), UploadsDir(), Init() (+72 more)

### Community 12 - "getAgentSystemPrompt"
Cohesion: 0.06
Nodes (48): getSharedMemorySummary(), AppendMemoryMD(), extractTaskMemory(), AgentMessage, parseMemoryEntries(), ReadMemoryMD(), readMemoryMDLocked(), SetMemoryMDFile() (+40 more)

### Community 13 - "time.Time"
Cohesion: 0.05
Nodes (62): CM(), InitConfigManager(), NewConfigManager(), ConfigManager, contextWithTimeout(), handleChat(), handleDashboard(), handleReceipts() (+54 more)

### Community 14 - "FormatHourlyReport"
Cohesion: 0.21
...
Cohesion: 0.22
Nodes (17): AgentMessage, confirmationDisplay(), ClearStopRequest(), ConsumeStopRequest(), sendScorpReply(), cleanToolCallTags(), getSessionSearchContext(), maxIterations() (+9 more)
...
Cohesion: 0.07
Nodes (37): init(), init(), init(), init(), executeMCPServerTool(), ActivateToolWithTTL(), ClearToolTTL(), IsDynamicModeEnabled() (+29 more)
...
Cohesion: 0.21
Nodes (9): init(), ExecuteListDir(), ExecuteSendFile(), ExecuteSystemInfo(), ExecuteWriteFile(), formatSendFileSize(), isGuestLinuxRootfs(), isPathAllowed() (+1 more)
...
Cohesion: 0.12
Nodes (19): init(), GetBoolArg(), GetIntArg(), GetStringArg(), GetStringSliceArg(), getUnclosedTags(), SplitMessage(), ExecuteCompose() (+11 more)
...
### Community 52 - "collector_coolify.go"
Cohesion: 0.28
...
Cohesion: 0.23
Nodes (20): executeOneShot(), executeTurn(), formatTerminalText(), handleCLISession(), handleCLISOP(), hasDebugFlag(), handleMCPCommand(), printBanner() (+12 more)
...
### Community 72 - "RecordToolReceipt"
Cohesion: 0.46
...
### Community 85 - "main"
Cohesion: 0.23
Nodes (12): RegisterAutonomous(), isCLIMode(), main(), InitModelUsage(), SOP, Dir(), GetSOP(), InitDefaultSOPs() (+4 more)

### Community 89 - "registerMCPToolsAsNative"
Cohesion: 0.15
Nodes (14): autoStats, sync.Mutex, TruncOutputTool(), buildArgDefsFromInputSchema(), MCPToolsDeferred(), registerMCPToolsAsNative(), StopMCPServers(), TestMCPToolsDeferredEnvParsing() (+6 more)
...
- **Why does `HandleTelegramAction()` connect `HandleTelegramAction` to `Manifest`, `chat.go`, `TaskPlan`, `getAgentSystemPrompt`, `time.Time`, `FormatHourlyReport`, `RunAgentSessionLoop`, `collector_security.go`, `GetAutonomyLevel`, `collector_system.go`, `CreateCheckpoint`, `CheckServerContracts`, `HandleConfirmation`, `ExecuteShell`, `collector_coolify.go`, `HandleModelCallback`, `collector_docker.go`, `SectionSecurity`, `main`, `registerMCPToolsAsNative`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `RunAgentSessionLoop()` connect `RunAgentSessionLoop` to `chat.go`, `rag_vector.go`, `TaskPlan`, `HandleTelegramAction`, `getAgentSystemPrompt`, `time.Time`, `ExecuteTool`, `GetAutonomyLevel`, `CreateCheckpoint`, `TestIntegrityStatus`, `PermissionDecision`, `RegisterTool`, `HandleConfirmation`, `ResolveAPIKey`, `GetStringArg`, `startCLI`, `TruncateStr`, `maybeCompactHistory`, `ExecuteTermuxAPI`, `testgate.go`, `IsDangerousCommand`, `IsContinuationDirective`, `HasGreenTestRun`, `wireCLICallbacks`, `GenerateContextualSessionTitle`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `StartDaemon()` connect `HandleTelegramAction` to `chat.go`, `cost_router.go`, `client.go`, `IsDangerousCommand`, `HandleModelCallback`, `rag_vector.go`, `collector_docker.go`, `skills.go`, `HandleConfirmation`, `LoadMCPConfig`, `getAgentSystemPrompt`, `time.Time`, `ScorpPath`, `ExecuteTool`, `StartTestEndpoint`, `main`, `registerMCPToolsAsNative`?**
